    ...
    <div class="container">
      ...
      <?php if (isset($_GET['success'])): ?>
        <div style="background:#d1fae5; color:#065f46; padding:1rem; border-radius:8px; margin-bottom:1.5rem;">
          Your appointment has been booked successfully. We'll be in touch to confirm.
        </div>
      <?php endif; ?>
      ...
      <?php if (empty($appointments)): ?>
        <p style="color:#666;">You have no upcoming appointments. <a href="book.php">Book one now →</a></p>
      <?php else: ?>
